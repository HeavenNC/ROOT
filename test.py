...
#client = LINE()
client = LINE("EychdIbyKCA6JwbWaTE7.NJBaaPWX4ChwW2QkFbp+nW.bDdLzK8PsArGZVtKEQzoijQ6UhjhFIX8dFLyj8721zs=")
                    ...
                    if to not in settings["botMute"] and to not in settings["botOff"]:
                        ...
                        if cmd == "memegen":
                           ...
                           for target in targets:
                            ...
                            client.sendMessage(to, contentMetadata={'countryCode': 'ID', 'i-installUrl': 'line://ti/p/~syifaabyananta', 'a-packageName': 'com.spotify.music', 'linkUri': 'line://ti/p/~syifaabyananta', 'subText': 'Just Newbie :v', 'a-installUrl': 'line://ti/p/~syifaabyananta', 'type': 'mt', 'previewUrl': image, 'a-linkUri': 'line://ti/p/~syifaabyananta', 'text': name, 'id': 'mt000000000a6b79f9', 'i-linkUri': 'line://ti/p/~syifaabyananta'}, contentType=19)
                        elif cmd == "mymid":
